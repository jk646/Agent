...
$serverScript = Join-Path $PSScriptRoot "start-wsl-search-text-server.ps1"
$consoleScript = Join-Path $PSScriptRoot "start-wsl-search-text-console.ps1"
...
if (-not $ready) { throw "search-text-tool did not create $Socket within 15 seconds." }
